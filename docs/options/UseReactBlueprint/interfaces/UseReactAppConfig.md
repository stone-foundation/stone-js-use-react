...
```ts
optional adapter?: Partial<AdapterConfig<any, any, any, ReactIncomingEvent, any, ReactOutgoingResponse>>;
```
...
```ts
optional adapters?: AdapterConfig<any, any, any, ReactIncomingEvent, any, ReactOutgoingResponse>[];
```
...
```ts
optional kernel?: KernelConfig<ReactIncomingEvent, ReactOutgoingResponse>;
```
...
```ts
optional lifecycleHooks?: LifecycleHookType<IBlueprint<any>, any, any, ReactIncomingEvent, ReactOutgoingResponse>;
```
...
```ts
optional middleware?: MixedPipe<ReactIncomingEvent, ReactOutgoingResponse>[];
```
